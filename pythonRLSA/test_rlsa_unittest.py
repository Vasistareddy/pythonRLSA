...
class TestRLSA(unittest.TestCase):
    ...
    def test_rlsa_hori(self):
        ...
        self.assertEqual(rlsa_fast(image, True, False, value).tolist(), out_h.tolist())
    ...
    def test_rlsa_vert(self):
        ...
        self.assertEqual(rlsa_fast(image, False, True, value).tolist(), out_v.tolist())
    ...
    def test_rlsa_hori_vert(self):
        ...
        self.assertEqual(rlsa_fast(image, True, True, value).tolist(), out_h_v.tolist())
    ...
    def test_bool(self):
        ...
        self.assertEqual(rlsa_fast(image, False, False, value).tolist(), image.copy().tolist())
    ...
    def test_value(self):
        ...
        self.assertEqual(rlsa_fast(image, True, False, -1).tolist(), image.copy().tolist())
