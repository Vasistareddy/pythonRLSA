...
for image_name in input_images:
    ...
    cv2.imwrite("output/both/" + image_name, out)
    ...
    # save this output as image
    cv2.imwrite("output/horizontal/" + image_name, out)
    ...
    # save this output as image
    cv2.imwrite("output/vertical/" + image_name, out)
    ...
    # save this output as image
    cv2.imwrite("output/none/" + image_name, out)
